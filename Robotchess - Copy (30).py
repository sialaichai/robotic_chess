...
# --- THE UNIFIED BRAIN CLASS (v9.0: "Sticky Grip" Protocol) ---
# This version removes 'grip' arguments from movement functions.
# The robot uses a Global Lock (self.current_grip) to ensure it NEVER relaxes.
# --- THE UNIFIED BRAIN CLASS (v9.1: Safe Grip & Simple Moves) ---
# --- THE UNIFIED BRAIN CLASS (v10: Anti-Stall Logic) ---
# --- THE UNIFIED BRAIN CLASS (v12: Speed, Sticky Grip & Fixed Trash) ---
# --- THE UNIFIED BRAIN CLASS (v14: Original Movement + Fixed Grip) ---
# --- THE UNIFIED BRAIN CLASS (v16: True Square Wave for Everything) ---
# --- THE UNIFIED BRAIN CLASS (v17: Frozen X/Y Lift - No Digging) ---
# --- THE UNIFIED BRAIN CLASS (v17.1: GUI Fix) ---
# --- THE UNIFIED BRAIN CLASS (v17.2: Fixed GUI Square Wave) ---
# --- THE UNIFIED BRAIN CLASS (v17.3: Fixed GUI Diagonal Drag) ---
# --- THE UNIFIED BRAIN CLASS (v17.4: True Square Wave with Pause) ---
# --- THE UNIFIED BRAIN CLASS (v17.5: Fixed GoTo Square Wave) ---
...
class RobotMotion:
    def __init__(self, robot, mapper, stop_check_callback):
        ...
        # Track where we are to ensure vertical lifts
        self.last_x = 0
        self.last_y = 20
    ...
    def smart_move_xyz(self, x, y, z):
        ...
        # Save these coords! We need them for the vertical lift later.
        self.last_x = x
        self.last_y = y
    ...
    def lift_vertical(self):
        ...
        Crucial Update: Added 0.5s sleep to ensure Z-axis completes movement
        BEFORE any X/Y movement begins. This stops the dragging.
        """
        if self.check_stop(): return
    ...
    def travel_straight(self, start_sq, end_sq):
        ...
        # 3. FLY TO TARGET (At Hover Height)
...
class RobotGUI:
    ...
    def goto_sq(self):
        ...
        # We pass a dummy lambda for the stop check
